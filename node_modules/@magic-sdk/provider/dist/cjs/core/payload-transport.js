...
function createMagicRequest(msgType, payload) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, storage_1.getItem('rt')];
                case 1:
                    rt = _a.sent();
                    if (!(sdk_environment_1.SDKEnvironment.platform === 'web')) return [3 /*break*/, 5];
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, web_crypto_1.createJwt()];
                case 3:
                    jwt = _a.sent();
                    return [3 /*break*/, 5];
                case 4:
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, storage_1.setItem('rt', event.data.rt)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
var PayloadTransport = /** @class */ (function () {
    ...
    PayloadTransport.prototype.post = function (overlay, msgType, payload) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, promise_tools_1.createPromise(function (resolve) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
