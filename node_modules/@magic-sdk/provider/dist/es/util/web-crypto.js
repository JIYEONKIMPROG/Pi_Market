...
export var STORE_KEY_PRIVATE_KEY = 'STORE_KEY_PRIVATE_KEY';
export var STORE_KEY_PUBLIC_JWK = 'STORE_KEY_PUBLIC_JWK';
var ALGO_NAME = 'ECDSA';
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, getItem(STORE_KEY_PRIVATE_KEY)];
                case 2:
                    privateJwk = _c.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getItem(STORE_KEY_PUBLIC_JWK)];
                case 1:
                ...
                case 2:
                    _a.sent();
                    _a.label = 3;
                case 3: return [2 /*return*/, getItem(STORE_KEY_PUBLIC_JWK)];
            }
        });
    });
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    // persist keys
                    return [4 /*yield*/, setItem(STORE_KEY_PRIVATE_KEY, nonExportPrivateKey)];
                case 5:
                    // persist keys
                    _a.sent();
                    // persist the jwk public key since it needs to be exported anyways
                    return [4 /*yield*/, setItem(STORE_KEY_PUBLIC_JWK, jwkPublicKey)];
                case 6:
                    // persist the jwk public key since it needs to be exported anyways
                    _a.sent();
                    return [2 /*return*/];
