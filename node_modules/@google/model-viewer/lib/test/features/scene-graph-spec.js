 ...
 */
import { $currentGLTF, SceneGraphMixin } from '../../features/scene-graph.js';
...
const RIGGEDFIGURE_GLB_PATH = assetPath('models/glTF-Sample-Models/2.0/RiggedFigure/glTF-Binary/RiggedFigure.glb');
suite('ModelViewerElementBase with SceneGraphMixin', () => {
    ...
    suite('scene export', () => {
        suite('with a loaded model', () => {
            ...
            test(`Setting varianName to null results in primitive
