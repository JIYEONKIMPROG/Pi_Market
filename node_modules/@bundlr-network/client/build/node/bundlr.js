...
class NodeBundlr extends bundlr_1.default {
    ...
    constructor(url, currency, wallet, config) {
        ...
        this.currencyConfig = (0, currencies_1.default)(this.currency, wallet, config === null || config === void 0 ? void 0 : config.providerUrl, config === null || config === void 0 ? void 0 : config.contractAddress);
