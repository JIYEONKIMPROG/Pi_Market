...
var useMedia = function useMedia() {
  var isMd = (0, _useMediaQuery.default)(MediaQueryEnum.md.matchMedia);
  var isLg = (0, _useMediaQuery.default)(MediaQueryEnum.lg.matchMedia);
  var isXxl = (0, _useMediaQuery.default)(MediaQueryEnum.xxl.matchMedia);
  var isXl = (0, _useMediaQuery.default)(MediaQueryEnum.xl.matchMedia);
  var isSm = (0, _useMediaQuery.default)(MediaQueryEnum.sm.matchMedia);
  var isXs = (0, _useMediaQuery.default)(MediaQueryEnum.xs.matchMedia);
