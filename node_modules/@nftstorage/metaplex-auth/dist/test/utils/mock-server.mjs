...
import fetch, { Headers, Request as FetchRequest, Response as FetchResponse, } from '@web-std/fetch';
...
export class Service {
    ...
    get address() {
        const { port, address, family } = /** @type {import('net').AddressInfo} */ (this.server.address());
