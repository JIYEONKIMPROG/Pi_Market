...
export function MetaplexAuthWithSigner(signMessage, publicKey, opts) {
    const chain = 'solana';
...
export function MetaplexAuthWithSecretKey(privkey, opts) {
...
export async function makeMetaplexUploadToken(auth, rootCID) {
    const tags = {
        [TagChain]: auth.chain,
