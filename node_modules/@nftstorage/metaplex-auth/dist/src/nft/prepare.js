 ...
 * @returns
 */
export async function prepareMetaplexNFT(metadata, imageFile, ...additionalAssetFiles) {
...
function replaceFileRefsWithIPFSLinks(metadata, imageFilename, additionalFilenames, assetRootCID) {
    ...
    const files = metadata.properties.files.flatMap((f) => {
