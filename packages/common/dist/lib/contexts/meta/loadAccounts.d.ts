...
export declare const processMints: (connection: Connection, mintList: StringPublicKey[], tempCache: MetaState, updateTemp: UpdateStateValueFunc, sourceMessage?: string) => Promise<void>;
export declare const pullMintsMetadata: (connection: Connection, mintList: StringPublicKey[], tempCache: MetaState, sourceMessage?: string) => Promise<MetaState>;
...
export declare const pullAuctionData: (connection: Connection, auction: StringPublicKey, tempCache: MetaState) => Promise<MetaState>;
